...
<body>
    ...
    <?php if ($this->session->userdata('level') === 'admin') : ?>
        <div class="typo-headers">
            <h2 class="display-5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Data Akun</h2>
        </div>
        <hr>
                    ...
                    <div class="col-md-6 offset-md-3">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <strong class="card-title pl-2">Data Pengguna</strong>
                            </div>
                            <div class="card-body">
                                <div class="mx-auto d-block">
                                    ...
                                    <div class="card-text text-sm-center">
                                        <div class="form-group row">
                                            <label for="inputnama_user" class="col-sm-4 col-form-label">Nama Pengguna</label>
                                            <div class="col-sm-6">
                                        ...
                                        <br>
                                        <div class='btn btn-success ubah-akun' data-toggle='modal' data-id=".$value['id'].">Ubah</button></div>
                                    </div>
                                </div>
                            </div>
                        </div>
